    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=datetime.datetime(2018, 9, 29, 17, 21, 46, 642733), verbose_name='创建时间')),
                ('is_pay', models.BooleanField(verbose_name='是否支付')),
                ('total_price', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='总价格')),
